import{i as f,h,d,P as u,u as p,j as o}from"./index-gK2J3_II.js";import{u as P}from"./useQuery-h9sTdRQf.js";import{b as c}from"./apiProduct-1-Ok6Rb-.js";import{S as x}from"./Spinner-fJObtOIq.js";import{P as j}from"./Pagination-vhsxsz_6.js";import{E as q}from"./EmptySection-aXdFFGY5.js";import{P as C}from"./ProductItemMini-eCEikjqv.js";import"./utils-1RRThafF.js";import"./helpers-o6nrGciX.js";import"./AddProductToCartBtn-aujmzxQ9.js";function S(){const i=f(),{id:t}=h(),[s]=d(),n=s.get("page")?Number(s.get("page")):1,r=(n-1)*u,{isLoading:a,data:e,error:y}=P({queryKey:["categoryProducts",t,r],queryFn:()=>c(t,r)}),m=e==null?void 0:e.count,g=e==null?void 0:e.products,l=Math.ceil(m/u);return n<l&&i.prefetchQuery({queryKey:["categoryProducts",t,r+1],queryFn:()=>c(t,r+1)}),n>0&&i.prefetchQuery({queryKey:["categoryProducts",t,r-1],queryFn:()=>c(t,r-1)}),{isLoading:a,products:g,error:y,count:m}}const w=p.div`
  width: 100%;
  display: flex;
