import{i as y,d as l,P as p,u,j as t,r as x}from"./index-tiG3UDW2.js";import{u as P}from"./useQuery-eENayJcY.js";import{a as d}from"./apiProduct-il8IqXCH.js";import{S}from"./Spinner-DmyEU9UC.js";import{P as j}from"./ProductItemMini-OZXsAvuE.js";import{E as q}from"./EmptySection-ie_dkvc0.js";import{P as w}from"./Pagination-1cutIt2a.js";import"./utils-1RRThafF.js";import"./helpers-o6nrGciX.js";import"./AddProductToCartBtn-9Ths0ekZ.js";function E(){const s=y(),[e]=l(),o=e.get("page")?Number(e.get("page")):1,r=e.get("title")&&e.get("title"),n=e.get("categoryId")&&e.get("categoryId"),i=(o-1)*p,{isLoading:c,data:a,error:h}=P({queryKey:["productsSearch",i,r,n],queryFn:()=>d(i,r,n)}),m=a==null?void 0:a.count,g=a==null?void 0:a.products,f=Math.ceil(m/p);return o<f&&s.prefetchQuery({queryKey:["productsSearch",i+1,r,n],queryFn:()=>d(i+1,r,n)}),o>0&&s.prefetchQuery({queryKey:["productsSearch",i-1,r,n],queryFn:()=>d(i-1,r,n)}),{isLoading:c,products:g,count:m,error:h}}const I=u.div`
  width: 100%;
  display: flex;
