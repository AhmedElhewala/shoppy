import{u as H}from"./useQuery-h9sTdRQf.js";import{i as R,d as k,P as I,u as l,r as x,j as t,am as D,_ as L}from"./index-gK2J3_II.js";import{e as M}from"./apiProduct-1-Ok6Rb-.js";import{u as J}from"./useCategoryList-qz3MIW8e.js";function te(){const e=R(),[i]=k(),u=i.get("page")?Number(i.get("page")):1,n=i.get("price")&&Number(i.get("price")),a=i.get("price_min")&&Number(i.get("price_min")),o=i.get("price_max")&&Number(i.get("price_max")),s=i.get("title")&&i.get("title"),d=i.get("categoryId")&&i.get("categoryId"),p=(u-1)*I,{isLoading:h,data:c,error:m}=H({queryKey:["productsList",p,n,a,o,s,d],queryFn:()=>M(p,n,a,o,s,d)}),f=c==null?void 0:c.count,g=c==null?void 0:c.products,v=Math.ceil(f/I);return u<v&&e.prefetchQuery({queryKey:["productsList",p+1,n,a,o,s,d],queryFn:()=>M(p+1,n,a,o,s,d)}),u>0&&e.prefetchQuery({queryKey:["productsList",p-1,n,a,o,s,d],queryFn:()=>M(p-1,n,a,o,s,d)}),{isLoading:h,products:g,count:f,error:m}}const U=l.div`
  width: 100%;
  display: flex;
  align-items: start;
  gap: 2rem;
